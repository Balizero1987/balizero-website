...
Only `verified` records may enter the public `/news` selector. Records with a missing date or category remain explicit rather than receiving inferred values. Reading time, summaries and article bodies are not part of this source-only contract.
